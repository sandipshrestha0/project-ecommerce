...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2022 at 11:43 AM
...
(1, 'Adventure Tourism Package', '                                    engaging in thrilling physical, natural or cultural activities.                                ', 1),
(2, 'Wildlife Tourism Package', 'experience with nature, wild-life and adventure ', 1),
(3, 'Pilgrimage Tourism Package', 'the traditional culture, temple architecture, art forms and rituals', 1),
(4, 'Cultural Tourism Package', ' exploration of the different shades of Nepali culture.', 1),
(5, 'Honeymoon Tourism Package', ' romantic vacation with their partner.', 1);
...
(11, 'suman', 'suman@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'ktm', 'ktm', 'asdf', '09887', 'Bangladesh', 0),
(12, 'sandiip', 'sand@gmail.com', 'aabd333347567f016d0b431391006459', 'ktm', 'padampur', '977', '98876665656', 'null', 0);
...
(10, 12, 10, 'Samsung mobile', 1000, 1, '');
...
INSERT INTO `tbl_product` (`product_id`, `product_title`, `product_long_description`, `product_image`, `product_price`, `product_feature`, `product_category`, `product_author`, `product_view`, `published_date`, `publication_status`) VALUES
(1, 'Ultraboost DNA Black Python Shoes', 'Black pythons are sleek, cool and a little bit dangerous. Channel the exotic beauty of the Australian snake and make it yours in these adidas Ultraboost DNA Black Python Shoes. The stretchy knit upper features snakeskin-inspired details. Energy-returning cushioning keeps you comfortable when you\'re on the move.', 'feature-pic1.jpg', 19500, 1, 6, 1, 0, '2017-11-30 14:24:41', 0),
(2, 'Face Covers 3-Pack', 'Made with soft, breathable fabric the adidas Face Cover is comfortable, washable and reusable for practicing healthy habits every day. This cover is not a medically-graded mask nor personal protective equipment.', 'feature-pic2.jpg', 1250, 1, 5, 1, 0, '2017-11-30 14:29:04', 1),
(3, 'Slim Fit Linen Blazer', '                                    Single-breasted blazer in woven linen fabric. Narr', 'Untitled-2-removebg-preview.png', 12500, 1, 4, 1, 0, '2017-11-30 14:38:25', 1),
(5, 'Razer 15.6', 'Designed for gaming, the Razer 15.6\" Blade 15 Gaming Laptop combines mobility with performance. Graphics are handled by the dedicated NVIDIA GeForce GTX 1660 Ti graphics card with VRAM. It also features a 10th Gen 2.6 GHz Intel Core i7-10750H six-core processor and 16GB of 2933 MHz of DDR4 RAM. Its 256GB NVME PCIe M.2 SSD allows for fast boot times. For online multiplayer features, the Razer Blade 15 can utilize Wi-Fi 6 (802.11ax) or a wired Gigabit Ethernet connection. It also supports wireless accessories via Bluetooth 5.1 technology. The Razer Blade 15 features a precision-crafted aluminum chassis.\n\nThe 15.6\" display features a FHD 1920 x 1080 resolution and are individually factory calibrated, providing 100% of the sRGB color space. The bezels are thin, measuring in at about 4.9mm. The screen also has a matte finish to reduce glare in brightly-lit environments. The keyboard is backlit and supports Razer Chroma single-zone RGB lighting. Other features included Thunderbolt 3, USB Type-C, USB Type-A, and a 3.5mm audio jack. Windows 10 Home is the installed operating system.', 'preview-img.jpg', 230000, 1, 1, 1, 0, '2017-11-30 14:40:34', 1),
(6, 'Samsung Galaxy S21 Ultra', 'Samsung Electronics Co., Ltd. unveiled the Galaxy S21 Ultra, a flagship that pushes the boundaries of what a smartphone can do. The S21 Ultra pulls out all the stops for those who want Samsung’s best-of-the-best with our most advanced pro-grade camera system and our brightest, most intelligent display. It takes productivity and creativity up a notch by bringing the popular S Pen experience to the Galaxy S series for the first time.</span>', 'sm21u.jpg', 155000, 1, 3, 1, 0, '2021-05-12 09:20:39', 1),
(7, 'paidal yatra', '                                    <span style=\"font-family: AdihausDIN, Helvetica, Arial, sans-serif; font-size: 16px; white-space: pre-line; background-color: rgb(255, 255, 255);\">dami xaa</span><span style=\"font-family: AdihausDIN, Helvetica, Arial, sans-serif; font-size: 16px; white-space: pre-line; background-color: rgb(255, 255, 255);\"></span>                                ', 'logo_copy.png', 16850, 1, 1, 1, 0, '2021-05-12 16:00:39', 1),
(13, 'kalinchowk', 'cool', 'creative-mountain-everest-logo-design-vector-2E30H5N1.jpg', 200000, 0, 1, 1, 0, '2022-04-01 03:31:04', 1),
(14, 'kalinchowk', '                                    dasfkjsdaf                                ', 'ready1.jpg', 90000, 0, 1, 1, 0, '2022-04-03 04:15:39', 1);
...
(13, 0, 'suman', 'sauman@gmail.com', 'chitwan', 'bhartpur', 'USA', '98765', 'naryan');
...
(4, 'suman', '20220104150705_IMG_9872.JPG', 'http://localhost/shop/single/5', 1),
(5, 'slider', '20220104162429_IMG_9967.JPG', 'http://localhost/shop/single/5', 1),
(6, 'slider 3', '20220103173925_IMG_9769.JPG', 'http://localhost/shop/single/3', 1),
(7, 'pkr', 'pokhara-1699787_1280_201806291930062.jpg', 'http://localhost/shop/single/pkr', 1);
